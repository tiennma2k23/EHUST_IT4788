...
class EditSurvey extends StatefulWidget {
  final Survey? survey;
  int index;
  EditSurvey({required this.survey, required this.index});
  @override
...
class _EditSurveyState extends State<EditSurvey> {
  ...
  Widget build(BuildContext context) {
    ...
    nameController.text = widget.survey!.title!;
        ...
        body: Padding(
          ...
          child:SingleChildScrollView( child: Column(
            ...
            children: [
              ...
              OutlinedButton(
                onPressed: () {
                  surveyProvider.edit_survey(context, _file!, widget.survey!.id!.toString(), _dateController.text, descriptionController.text, widget.survey!.classId!);
                },
